      ...
      sections: [
        {
          ...
          content: [
            ...
            },
            {
              ...
              items: [
                '<b>الأنماط المعمارية الرئيسية (Architectural Patterns):</b> تحليل مقارن بين Monolith و Microservices و Serverless، مع توضيح متى تختار كل نمط في دورة حياة SaaS.',
          ...
          content: [
            ...
            { type: ContentType.HEADING3, text: 'لماذا PostgreSQL تتفوق في SaaS؟' },
            {
              ...
              items: [
                ...
                '<b>الأمان المتقدم:</b> الميزة الأهم هي <b>أمان مستوى الصف (Row-Level Security - RLS)</b>، والتي سنتناولها بالتفصيل، وهي تعتبر شبكة أمان حاسمة في بنية Multi-Tenant.'
              ]
            },
            {
                type: ContentType.HEADING3,
