  ...
  chapters: [
          ...
          content: [
            {
              ...
              text: 'تخيل أنك تقود طائرة حديثة في ليلة عاصفة. هل ستعتمد على حدسك لتحديد الارتفاع والسرعة واتجاه الريح؟ أم ستنظر إلى لوحة أجهزة القياس التي أمامك، والتي تعرض كل مؤشر حيوي بدقة؟ في عالم **SaaS (البرمجيات كخدمة - Software as a Service)**، إدارة منتجك بدون بيانات تحليلية دقيقة هو تمامًا مثل قيادة تلك الطائرة في الظلام وأنت مغمض العينين. قد تظل في الجو لفترة، ولكن الهبوط الآمن ليس مضمونًا.',
            },
            {
              type: ContentType.PARAGRAPH,
            ...
            },
            {
              ...
              items: [
                ...
                '<b>تحليل المؤشرات الحيوية (KPIs)</b> مثل MRR، Churn Rate، LTV، وRetention، وكيفية حسابها وتفسيرها بعمق.',
                '<b>أكواد عملية ومفصلة</b> لجمع البيانات من الواجهة الأمامية، تخزينها في الواجهة الخلفية، وعرضها في لوحة تحكم تفاعلية.',
                '<b>استخدام اختبار A/B (A/B Testing)</b> كأداة علمية لاتخاذ قرارات مبنية على الأدلة، وليس على الآراء الشخصية.',
    ...
    <div class="bg-stone-50 border border-stone-200 rounded-lg p-6 shadow-sm">
        ...
        },
        {
          ...
          icon: '📊',
          content: [
            { type: ContentType.HEADING3, text: '1. الإيراد الشهري المتكرر (Monthly Recurring Revenue - MRR)' },
            ...
            { type: ContentType.HEADING3, text: '2. معدل الانصراف (Churn Rate)' },
            ...
            { type: ContentType.HEADING3, text: '3. القيمة مدى الحياة للعميل (Customer Lifetime Value - LTV)' },
            ...
            { type: ContentType.HEADING3, text: '4. تكلفة جذب عميل (Customer Acquisition Cost - CAC)' },
            ...
            { type: ContentType.HEADING3, text: '6. فترة استرداد تكلفة العميل (CAC Payback Period)' },
...
def get_mrr_over_time():
    ...
    return jsonify(formatted_data)`},
        ...
        },
        {
          ...
          icon: '🔬',
          content: [
            { type: ContentType.PARAGRAPH, text: 'الآراء الشخصية يمكن أن تكون قاتلة. اختبار A/B (A/B Testing) هو الطريقة الوحيدة لمعرفة ما ينجح حقًا. إنها تجربة علمية تقارن بين نسختين من شيء ما (صفحة، زر، نص) لمعرفة أيهما يحقق نتيجة أفضل.'},
