          ...
          content: [
            {
              ...
              text: 'في عالم <b>SaaS (Software as a Service)</b>، لا يُقاس نجاح النظام فقط بجودة الكود أو جمال التصميم، بل <b>بقدرته على تحويل المستخدم إلى عميل يدفع</b>.',
            },
            {
              type: ContentType.PARAGRAPH,
              text: 'الواجهة الأمامية تجذب، والواجهة الخلفية تُعالج، لكن <b>نظام الدفع هو الذي يُحقق الإيراد</b>.',
            },
            {
              type: ContentType.PARAGRAPH,
            ...
            },
            {
              ...
              items: [
                '<b>تصميم نظام اشتراكات متعدد المستويات</b>.',
                '<b>دمج Stripe وPayPal وPaddle</b>.',
                '<b>أكواد عملية</b> لإدارة الفواتير، التحديثات، والإشعارات.',
    ...
    <div class="bg-stone-50 p-4 rounded-lg border border-stone-200 flex items-start gap-3">
        ...
        },
        {
          ...
          content: [
            ...
            { type: ContentType.HEADING4, text: '💡 ميزة فريدة: **Customer Portal**' },
